...
import type { TestServiceService } from './test-service.class'
...
export const testServiceResolver = resolve<TestService, HookContext<TestServiceService>>({})

export const testServiceExternalResolver = resolve<TestService, HookContext<TestServiceService>>({})
...
export const testServiceDataResolver = resolve<TestService, HookContext<TestServiceService>>({})
...
export const testServicePatchResolver = resolve<TestService, HookContext<TestServiceService>>({})
...
export const testServiceQueryResolver = resolve<TestServiceQuery, HookContext<TestServiceService>>({})
